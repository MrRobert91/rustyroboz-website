...
const Card = ({ post, type }) => {
  return (
    <Link
      href={`/${type}/${post.slug}`}
      className="block p-6 bg-white rounded-lg border border-gray-200 shadow-md hover:shadow-xl hover:-translate-y-1 transition-transform duration-300 ease-in-out group focus-visible:ring-2 focus-visible:ring-blue-600 focus-visible:outline-none"
    >
